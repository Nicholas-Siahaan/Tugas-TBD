...
<body>
    ...
    ?>
        <div class="floating-add-btn" id="floatingAddBtn">
            <a href="add-book.php" class="add-btn" style="text-decoration: none; color: white; background: #2b6777; border-radius: 50%; width: 50px; height: 50px; display: flex; align-items: center; justify-content: center; font-size: 24px;">
                <i class='bx bx-plus'></i>
            </a>
        </div>
    <?php
    } else {
        // Jika bukan admin, tidak ditampilkan
        // Jika ingin menolak akses sepenuhnya (bukan hanya tombolnya), bisa pakai ini:
        echo "Akses ditolak.";
        exit();
    }
?>
